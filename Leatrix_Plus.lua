...
----------------------------------------------------------------------
	...
	function LeaPlusLC:Isolated()
		...
		do
			...
			LeaPlusLC:MakeCB(MountPanel, "MuteMechsuits", "Mechsuits", 150, -132, false, "If checked, mechsuits will be quieter.|n|nThis applies to Felsteel Annihilator, Lightforged Warframe, Sky Golem and other mechsuits.")
			LeaPlusLC:MakeCB(MountPanel, "MuteOttuks", "Ottuks", 150, -152, false, "If checked, ottuks will be quieter.")
			LeaPlusLC:MakeCB(MountPanel, "MuteRazorwings", "Razorwings", 150, -172, false, "If checked, razorwings will be muted.")
			LeaPlusLC:MakeCB(MountPanel, "MuteRockets", "Rockets", 150, -192, false, "If checked, rockets will be muted.")
			LeaPlusLC:MakeCB(MountPanel, "MuteSoulEaters", "Soul Eaters", 150, -212, false, "If checked, Gladiator Soul Eater mounts will be quieter.")
			...
			LeaPlusLC:MakeCB(MountPanel, "MuteStriders", "Mechstriders", 284, -92, false, "If checked, mechanostriders will be quieter.")
