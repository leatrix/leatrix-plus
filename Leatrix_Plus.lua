...
----------------------------------------------------------------------
	...
	function LeaPlusLC:Isolated()
		...
		do
			...
			LeaPlusLC:MakeCB(MountPanel, "MuteBikes", "Bikes", 16, -92, false, "If checked, most of the bike mount sounds will be muted.")
			LeaPlusLC:MakeCB(MountPanel, "MuteTravelers", "Travelers", 16, -112, false, "If checked, traveling merchant greetings and farewells will be muted.|n|nThis applies to Traveler's Tundra Mammoth, Grand Expedition Yak and Mighty Caravan Brutosaur.")
			LeaPlusLC:MakeCB(MountPanel, "MuteUnicorns", "Unicorns", 16, -132, false, "If checked, unicorns will be quieter.|n|nThis applies to Lucid Nightmare, Wild Dreamrunner, Pureheart Courser and other unicorn mounts.")
			LeaPlusLC:MakeCB(MountPanel, "MuteGyrocopters", "Gyrocopters", 16, -152, false, "If checked, gyrocopters will be muted.|n|nThis applies to Mimiron's Head, Mecha-Mogul MK2 and other gyrocopter mounts.|n|nEnabling this option will also mute airplane gear shift sounds.")
			LeaPlusLC:MakeCB(MountPanel, "MuteRockets", "Rockets", 16, -172, false, "If checked, rockets will be muted.")
			LeaPlusLC:MakeCB(MountPanel, "MuteAerials", "Aerials", 16, -192, false, "If checked, jet aerial units will be quieter.|n|nThis applies to Aerial Unit R-21X and Rustbolt Resistor.")
			LeaPlusLC:MakeCB(MountPanel, "MuteHovercraft", "Hovercraft", 16, -212, false, "If checked, hovercraft will be quieter.|n|nThis applies to Xiwyllag ATV.")
			LeaPlusLC:MakeCB(MountPanel, "MuteSoulseekers", "Soulseekers", 16, -232, false, "If checked, soulseekers will be quieter.|n|nThis applies to Corridor Creeper, Mawsworn Soulhunter and Bound Shadehound.")
			LeaPlusLC:MakeCB(MountPanel, "MuteAirships", "Airships", 16, -252, false, "If checked, airships will be muted.|n|nThis applies to airship mounts and transports.")

			LeaPlusLC:MakeCB(MountPanel, "MuteZeppelins", "Zeppelins", 150, -92, false, "If checked, zeppelins will be muted.|n|nThis applies to zeppelin mounts and transports.")
			LeaPlusLC:MakeCB(MountPanel, "MuteFurlines", "Furlines", 150, -112, false, "If checked, furlines will be muted.|n|nThis applies to Sunwarmed Furline.")
			LeaPlusLC:MakeCB(MountPanel, "MuteRazorwings", "Razorwings", 150, -132, false, "If checked, razorwings will be muted.")
			LeaPlusLC:MakeCB(MountPanel, "MuteSoulEaters", "Soul Eaters", 150, -152, false, "If checked, Gladiator Soul Eater mounts will be quieter.")
			...
			LeaPlusLC:MakeCB(MountPanel, "MuteStriders", "Mechstriders", 150, -192, false, "If checked, mechanostriders will be quieter.")
			LeaPlusLC:MakeCB(MountPanel, "MuteMechSteps", "Mechsteps", 150, -212, false, "If checked, footsteps for mechanical mounts will be muted.")
			LeaPlusLC:MakeCB(MountPanel, "MuteBrooms", "Brooms", 150, -232, false, "If checked, broom mounts will be muted.")
			LeaPlusLC:MakeCB(MountPanel, "MuteBanLu", "Ban-Lu", 150, -252, false, "If checked, Ban-Lu will no longer talk to you.")

			LeaPlusLC:MakeCB(MountPanel, "MuteDragonriding", "Dragonriding", 284, -92, false, "If checked, dragonriding mounts will be quieter.")
			LeaPlusLC:MakeCB(MountPanel, "MuteOttuks", "Ottuks", 284, -112, false, "If checked, ottuks will be quieter.")
		...
		do
			...
			LeaPlusLC:MakeCB(SoundPanel, "MuteSunflower", "Sunflower", 150, -92, false, "If checked, the Singing Sunflower pet will be muted.")
			LeaPlusLC:MakeCB(SoundPanel, "MutePierre", "Pierre", 150, -112, false, "If checked, Pierre will be quieter.")
			...
			LeaPlusLC:MakeCB(SoundPanel, "MuteHarp", "Harp", 150, -192, false, "If checked, the Fae Harp toy will be muted.")

			LeaPlusLC:MakeTx(SoundPanel, "Combat", 284, -72)
			LeaPlusLC:MakeCB(SoundPanel, "MuteBattleShouts", "Shouts", 284, -92, false, "If checked, your character will not shout and wail during combat.")
			LeaPlusLC:MakeCB(SoundPanel, "MuteArena", "Arena", 284, -112, false, "If checked, arena announcers will be muted.")
