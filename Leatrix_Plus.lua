----------------------------------------------------------------------
-- 	Leatrix Plus 9.1.32 (17th December 2021)
----------------------------------------------------------------------
				...
				local function MakeButtons()
					...
					for i = 1, #temp do
						if temp[i] then
							...
							if name and btype == "Button" and not CustomAddonTable[name] and btn:GetScript("OnClick") and not string.find(name, "LibDBIcon") and not issecurevariable(name) and btn:IsShown() then
