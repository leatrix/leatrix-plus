----------------------------------------------------------------------
-- 	Leatrix Plus 9.1.23.alpha.14 (15th November 2021)
----------------------------------------------------------------------
...
----------------------------------------------------------------------
	...
	-- Version
	LeaPlusLC["AddonVer"] = "9.1.23.alpha.14"
...
----------------------------------------------------------------------
	...
	LeaPlusCB["FriendlyCommunities"]:SetPoint("LEFT", LeaPlusCB["FriendlyGuild"], "RIGHT", LeaPlusCB["FriendlyGuild"].f:GetStringWidth() + 6, 0)
